...
Start-Job -ScriptBlock { Start-Process -FilePath "D:\PhaniKumar\O365\setup.exe" -ArgumentList '/configure "D:\PhaniKumar\O365\configuration-Office365-x64.xml" /quiet'}
