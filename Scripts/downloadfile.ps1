...
Start-Process -FilePath "$env:Temp\odt.exe" -ArgumentList '/extract:"D:/O365" /quiet'
Invoke-Expression -Command "cmd.exe /c 'D:/O3652019/setup.exe' /download 'D:/O3652019/configuration-Office365-x64.xml'" 
Invoke-Expression -Command "cmd.exe /c 'D:/O3652019/setup.exe' /configure 'D:/O3652019/configuration-Office365-x64.xml' /S" 
